...
levels(crcdata$S_stakeholder_engagment_YN) = c("Y", "N")
levels(crcdata$S_stakeholder_engagment_YN) = c("Y", "N")
...
par(mar = c(8,4,4,4))
barplot(colSums(crcdata[,4:10]), las=2, main="Solution Types: N=18", names.arg = c("Technogical", "Policy", "Institutional", "Social", "Economic", "Ecological", "Educational"))


ggplot(colSums(crcdata[,4:10]), aes(x = type, y = total_yes)) + 
