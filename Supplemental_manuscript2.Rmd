...
train <- crcdata[ind==1,]
test <- crcdata[ind==2,]
rf <- randomForest(solution_proposed_YN ~STE_G_nominal+STE_G_instrumental+STE_G_representation+STE_G_transformative, data=train, proximity=TRUE) 
print(rf)
...
train <- crcdata[ind==1,]
test <- crcdata[ind==2,]
rf <- randomForest(solution_proposed_YN ~STE_IAP2_data_gathering+STE_IAP2_inform+STE_IAP2_consult+STE_IAP2_involve+STE_IAP2_collab+STE_IAP2_empower, data=train, proximity=TRUE) 
print(rf)
...
train <- crcdata[ind==1,]
test <- crcdata[ind==2,]
rf <- randomForest(solution_proposed_YN ~SC_researcher+SC_datagathering+SC_inform+SC_perspectives+SC_plan+SC_identify+SC_envision+SC_implement, data=train, proximity=TRUE) 
print(rf)
...
train <- crcdata[ind==1,]
test <- crcdata[ind==2,]
rf <- randomForest(S_model_YN ~ STE_G_nominal+STE_G_instrumental+STE_G_representation+STE_G_transformative, data=train, proximity=TRUE) 
print(rf)
...
train <- crcdata[ind==1,]
test <- crcdata[ind==2,]
rf <- randomForest(S_model_YN ~ STE_IAP2_data_gathering+STE_IAP2_inform+STE_IAP2_consult+STE_IAP2_involve+STE_IAP2_collab+STE_IAP2_empower, data=train, proximity=TRUE) 
print(rf)
...
train <- crcdata[ind==1,]
test <- crcdata[ind==2,]
rf <- randomForest(S_model_YN ~ SC_researcher+SC_datagathering+SC_inform+SC_perspectives+SC_plan+SC_identify+SC_envision+SC_implement, data=train, proximity=TRUE) 
print(rf)
...
train <- crcdata[ind==1,]
test <- crcdata[ind==2,]
rf <- randomForest(solution_proposed_YN ~G_notdescribed+G_local+G_regional+G_national+G_multination+G_global, data=train, proximity=TRUE) 
print(rf)
