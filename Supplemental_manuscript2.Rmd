...
<!-- ## Regression Testing - Diversity of stakeholders vs solution -->
...
<!-- ## Odds Ratio - Diversity of stakeholders vs solution -->
...
<!-- ## Ensembed Decision Tree - Diversity of stakeholders vs solution -->
...
# train <- crcdata[ind==1,]
# test <- crcdata[ind==2,]
# rf <- randomForest(solution_proposed_YN ~ST_farmers + ST_combined_gov  + ST_combined_coalition + ST_combined_industry + ST_migrants + ST_public + ST_university + ST_experts, data=train, proximity=TRUE, importance=TRUE, importance=TRUE) 
# print(rf)
# 
# p2 <- predict(rf, test)
# confusionMatrix(p2, test$solution_proposed_YN)
