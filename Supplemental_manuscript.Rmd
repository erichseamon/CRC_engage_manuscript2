...
rf_weighted <- train(
  solution_proposed_YN ~ST_combined_gov+ST_tribal+ST_combined_coalition+ST_combined_industry+ST_migrants+ST_youth+ST_public+ST_university+ST_experts+G_local+G_regional+G_national+G_multinational+G_global+year+L_region_3+ST_ratio+R_ratio,
  data = crcdata,
  method = "ranger",
  trControl = ctrl, 
  tuneGrid = expand.grid(
